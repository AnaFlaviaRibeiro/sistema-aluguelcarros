...
import heroImg from '../assets/carros.jpeg'
</script>
  ...
  <div class="home">
    <section class="hero">
      ...
      <div class="hero-visual" aria-hidden="true">
        <div class="hero-glow" />
        <img :src="heroImg" alt="" class="hero-img" width="520" height="360" />
      </div>
    </section>
...
.btn-primary:hover {
  ...
  box-shadow: 0 6px 20px rgb(37 99 235 / 40%);
}
